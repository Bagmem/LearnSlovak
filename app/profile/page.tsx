...
function CircularProgress({
  ...
  return (
    ...
    >
      ...
      <span className="text-xs font-semibold mt-2 text-gray-600 dark:text-gray-300">
        {label}
      </span>
    </motion.div>
  )
...
export default function ProfilePage() {
  ...
  async function handleSaveName() {
    ...
    try {
      ...
      if (authError) {
        console.warn("Имя в auth metadata не обновилось:", authError)
      }
  ...
  async function handleAvatarUpload(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      if (authError) {
        console.warn("Аватар в auth metadata не обновился:", authError)
      }
  ...
  const levelStats = useMemo(() => {
    ...
    return levels.map((levelItem) => {
      ...
      return {
        level: levelItem,
        total,
        learned: completedCategories,
        percent: total ? (completedCategories / total) * 100 : 0,
      }
    })
        ...
        <div className="w-full max-w-md rounded-2xl bg-white dark:bg-gray-800 shadow-xl p-8 text-center">
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <Link
              ...
              className="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-600 py-3 text-center font-bold transition"
            >
              На главную
            </Link>
          </div>
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-8">
        ...
        >
          <Link
            href="/"
            onClick={() => playClickSound()}
            className="inline-flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm px-5 py-2.5 text-sm font-bold text-gray-700 dark:text-gray-200 shadow-sm transition hover:bg-gray-50 dark:hover:bg-gray-700"
          >
            <FaArrowLeft /> На главную
          </Link>
          <button
            onClick={handleLogout}
            className="inline-flex items-center gap-2 rounded-xl border border-red-200 dark:border-red-700 bg-red-50 dark:bg-red-900/30 px-5 py-2.5 text-sm font-bold text-red-600 dark:text-red-300 shadow-sm transition hover:bg-red-100 dark:hover:bg-red-900/50"
          >
            <FaSignOutAlt /> Выйти
          </button>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 space-y-4">
              ...
              <div className="p-5">
                <div className="flex flex-col items-center text-center">
                  ...
                  {editingName ? (
                    <div className="flex flex-wrap items-center justify-center gap-2 mt-2">
                      <input
                        ...
                        className="rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 px-3 py-1 text-gray-800 dark:text-white text-sm outline-none focus:ring-2 focus:ring-orange-400"
                      />
                      <button
                        onClick={handleSaveName}
                        className="rounded-lg bg-orange-500 px-3 py-1 text-xs font-black text-white hover:bg-orange-600 transition"
                      >
                        Сохранить
                      </button>
                    </div>
                  ...
                  <button
                    ...
                    className="mt-2 inline-flex items-center gap-1 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 px-3 py-1 text-xs font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 transition"
                  >
                    <FaPen size={10} /> Редактировать
                  </button>
                </div>
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <StatCard delay={0.2}>
                <div
                  className="rounded-xl bg-white dark:bg-gray-800 bg-noise shadow-md border border-gray-100 dark:border-gray-700 p-3 text-center cursor-pointer hover:shadow-lg transition-all hover:border-orange-300 dark:hover:border-orange-700"
                  onClick={() => {
                    playClickSound()
                    setShowXpModal(true)
                  }}
            ...
            <StatCard delay={0.4}>
              <div className="rounded-xl bg-white dark:bg-gray-800 bg-noise shadow-md border border-gray-100 dark:border-gray-700 p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button className="text-xs bg-orange-100 dark:bg-orange-900/30 px-2 py-1 rounded-full text-orange-600 dark:text-orange-400 opacity-60 cursor-not-allowed">
                    Пригласить
                  </button>
                </div>
            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20">
                <h2 className="text-lg font-black text-gray-800 dark:text-white flex items-center gap-2">
                  <FaStar className="text-orange-500" /> Прогресс уровня профиля
                </h2>
                <button
                  onClick={() => {
                    playClickSound()
              ...
              <div className="p-3 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                <button
                  ...
                  className="w-full py-1.5 bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold rounded-xl hover:shadow-lg transition"
                >
                  Закрыть
                </button>
              </div>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                <h2 className="text-lg font-black text-gray-800 dark:text-white flex items-center gap-2">
                  <FaGraduationCap className="text-orange-500" /> Прогресс по уровням языка
                </h2>
                <button
                  onClick={() => {
                    playClickSound()
              ...
              <div className="p-5 max-h-[70vh] overflow-y-auto">
                ...
                <h3 className="font-bold mt-4 mb-2 flex items-center gap-2 text-gray-800 dark:text-white">
                  <FaSkull className="text-red-500" /> Сложные слова
                </h3>
                  ...
                  <div className="space-y-2">
                    {hardWords.map((item, idx) => (
                      <div key={idx} className="flex justify-between border-b border-gray-100 dark:border-gray-700 pb-2">
                        <div>
                          <p className="font-bold text-sm text-gray-800 dark:text-white">{item.word}</p>
              ...
              <div className="p-4 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                <button
                  ...
                  className="w-full py-2 bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold rounded-xl"
                >
                  Закрыть
                </button>
              </div>
        ...
        {showAchievements && (
          ...
          >
            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                <h2 className="text-lg font-black text-gray-800 dark:text-white flex items-center gap-2">
                  <FaGem className="text-orange-500" /> Достижения
                </h2>
                <button
                  onClick={() => {
                    playClickSound()
