...
export default function SettingsModal({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-md" role="dialog" aria-modal="true" aria-labelledby="settings-title">
          <motion.div
          ...
          >
            ...
            <div className="p-6 space-y-6">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center shadow-md" aria-hidden="true">
                      <FaPalette className="text-white text-lg" aria-hidden="true" />
                    </div>
                    <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center shadow-md" aria-hidden="true">
                      {settings.isMuted ? <FaVolumeMute className="text-white text-lg" aria-hidden="true" /> : <FaVolumeUp className="text-white text-lg" aria-hidden="true" />}
                    </div>
                    <div>
                  ...
                  <button
                    ...
                    aria-label={settings.isMuted ? "Включить звук" : "Выключить звук"}
                  >
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <label htmlFor="volume-slider" className="text-sm font-medium text-gray-600 dark:text-gray-300">Громкость</label>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center shadow-md" aria-hidden="true">
                      <FaMicrophoneAlt className="text-white text-lg" aria-hidden="true" />
                    </div>
                    <div>
                  ...
                  <button
                    ...
                    role="switch"
                    aria-checked={settings.autoSpeakOnCorrect}
                    aria-label="Автоматическое озвучивание"
                  >
                    <span
                      className={`inline-block h-5 w-5 transform rounded-full bg-white shadow-md transition-all duration-300 ${
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <label htmlFor="rate-slider" className="text-sm font-medium text-gray-600 dark:text-gray-300">Скорость речи</label>
